...
#set noc_ddr_lpddr [create_bd_cell -type ip -vlnv xilinx.com:ip:axi_noc noc_ddr_lpddr]
#set_property -dict [list CONFIG.NUM_SI {0} CONFIG.NUM_MI {0} CONFIG.NUM_NMI {1} CONFIG.NUM_CLKS {0}] [get_bd_cells noc_ddr_lpddr]
...
set_property -dict [ list \
CONFIG.DATA_WIDTH {128} \
CONFIG.CONNECTIONS { M00_INI { read_bw {5} write_bw {5}} M05_INI { read_bw {1720} write_bw {1720}} } \
CONFIG.DEST_IDS {} \
...
#set_property -dict [list CONFIG.CONNECTIONS {M01_INI { read_bw {128} write_bw {128}} M05_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /cips_noc/S00_INI]
...
set dummy_slave_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vip dummy_slave_1 ]
set_property -dict [ list \
CONFIG.INTERFACE_MODE {SLAVE} \
] $dummy_slave_1

set dummy_slave_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vip dummy_slave_2 ]
set_property -dict [ list \
CONFIG.INTERFACE_MODE {SLAVE} \
] $dummy_slave_2

set dummy_slave_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vip dummy_slave_3 ]
set_property -dict [ list \
CONFIG.INTERFACE_MODE {SLAVE} \
] $dummy_slave_3
...
#connect_bd_intf_net                            [get_bd_intf_pins noc_ddr_lpddr/M00_INI] [get_bd_intf_pins cips_noc/S00_INI]
...
connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_pins CIPS_0/m_axi_fpd_aclk] [get_bd_pins axi_intc_cascaded_1/s_axi_aclk] [get_bd_pins axi_intc_parent/s_axi_aclk] [get_bd_pins cips_noc/aclk0] [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins icn_ctrl_1/aclk] [get_bd_pins icn_ctrl_1/aclk1] [get_bd_pins icn_ctrl_2/aclk] [get_bd_pins icn_ctrl_3/aclk] [get_bd_pins icn_ctrl_4/aclk] [get_bd_pins icn_ctrl_5/aclk] [get_bd_pins psr_100mhz/slowest_sync_clk] [get_bd_pins dummy_slave_0/aclk] [get_bd_pins dummy_slave_1/aclk] [get_bd_pins dummy_slave_2/aclk] [get_bd_pins dummy_slave_3/aclk]
...
connect_bd_net -net psr_100mhz_peripheral_aresetn [get_bd_pins axi_intc_cascaded_1/s_axi_aresetn] [get_bd_pins axi_intc_parent/s_axi_aresetn] [get_bd_pins icn_ctrl_1/aresetn] [get_bd_pins icn_ctrl_2/aresetn] [get_bd_pins icn_ctrl_3/aresetn] [get_bd_pins icn_ctrl_4/aresetn] [get_bd_pins icn_ctrl_5/aresetn] [get_bd_pins psr_100mhz/peripheral_aresetn] [get_bd_pins dummy_slave_0/aresetn] [get_bd_pins dummy_slave_1/aresetn] [get_bd_pins dummy_slave_2/aresetn] [get_bd_pins dummy_slave_3/aresetn]
...
assign_bd_address -offset 0x050000000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces CIPS_0/LPD_AXI_NOC_0] [get_bd_addr_segs noc_lpddr4/S01_INI/C1_DDR_CH1x2] -force
...
set_property PFM_NAME "xilinx.com:xd:vck190:01" [get_files [current_bd_design].bd]
