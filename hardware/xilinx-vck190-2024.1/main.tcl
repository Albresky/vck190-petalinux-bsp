...
set files [glob ./${proj_name}.runs/impl_1/*.rcdo ./${proj_name}.runs/impl_1/*.rnpi ./${proj_name}.runs/impl_1/*.pdi] 
foreach fl $files {
    set newfl [string map {_wrapper {}} [file tail $fl]]
    file copy $fl ./$output_dir/$newfl
}
                       
file copy -force ./${proj_name}.runs/impl_1/gen_files ./$output_dir/
file copy -force ./${proj_name}.runs/impl_1/static_files ./$output_dir/
